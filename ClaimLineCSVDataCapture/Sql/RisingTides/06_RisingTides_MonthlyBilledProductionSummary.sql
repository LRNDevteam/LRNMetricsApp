-- RisingTides — Monthly Claim Production Billed Summary
-- Rule:
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'RT_MonthlyBilledProductionSummary')
CREATE TABLE dbo.RT_MonthlyBilledProductionSummary
(
...
PRINT '06_RisingTides_MonthlyBilledProductionSummary.sql completed.';
