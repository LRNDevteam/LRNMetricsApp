...
--
-- List parameters (@PayerNames, @PanelNames) use '|' as the delimiter so payer/panel
-- names that contain commas are passed safely.
-- ============================================================
...
-- ============================================================
-- Payer Breakdown (Payer x Month)
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetRT_PayerBreakdown
    @PayerNames      NVARCHAR(MAX) = NULL,
    @PanelNames      NVARCHAR(MAX) = NULL,
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
...
-- Payer x Panel
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetRT_PayerByPanel
    @PayerNames      NVARCHAR(MAX) = NULL,
    @PanelNames      NVARCHAR(MAX) = NULL,
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
...
-- ============================================================
-- Coding Breakdown (BILLED claims). Returns TWO result sets:
--   1) PanelName, ClaimCount, TotalCharges
--   2) PanelName, CPTCodeXUnitsXModifier, ClaimCount, TotalCharges
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetRT_CodingBreakdown
...
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetRT_CPTBreakdown
    @PayerNames      NVARCHAR(MAX) = NULL,   -- accepted for signature parity
    @PanelNames      NVARCHAR(MAX) = NULL,   -- accepted for signature parity
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
    @FirstBillFrom   DATE          = NULL,
    @FirstBillTo     DATE          = NULL,
...
PRINT '14_RisingTides_ReadSPs.sql completed.';
