...
PRINT 'Creating type dbo.ClaimLevelDataTVP (PhiLife)...';
-- Column order MUST match the field order in PhiLifeFieldMappings.Json ClaimLevel > Fields.
...
(
    ...
    -- CSV-mapped columns (in PhiLifeFieldMappings.Json ClaimLevel field order)
    LabID                      NVARCHAR(500),
...
BEGIN
    ...
    BEGIN
        ...
        --    c.Panelname, c.CPTCode, c.Units, c.Modifier, c.POS, c.TOS,
        --    c.ChargeAmount, c.ChargeAmountPerUnit, c.AllowedAmount, c.AllowedAmountPerUnit,
        --    c.InsurancePayment, c.InsurancePaymentPerUnit, c.PatientPayment, c.PatientPaymentPerUnit,
        --    c.TotalPayments, c.InsuranceAdjustments, c.PatientAdjustments, c.TotalAdjustments,
        --    c.InsuranceBalance, c.PatientBalance, c.PatientBalancePerUnit, c.TotalBalance,
        --    c.CheckDate, c.PaymentPostedDate, c.ClaimStatus, c.PayStatus, c.DenialCode, c.DenialDate,
        --    c.ICDCode, c.DaystoDOS, c.RollingDays, c.DaystoBill, c.DaystoPost, c.ICDPointer,
        --    c.PatientName, c.ResponsibleParty, c.SubscriberId, c.EndDOS, c.BillOccurance, c.EntryUser,
        --    c.CPTUnits, c.CPTMOD, c.CPTs, c.PostedWeek,
        --    c.InsertedDateTime
...
PRINT 'PhiLife ClaimLevel TVP/SP recreate script completed.';
