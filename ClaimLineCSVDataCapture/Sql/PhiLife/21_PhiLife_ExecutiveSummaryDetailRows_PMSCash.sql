-- ============================================================
-- PhiLife – Executive Summary PMS / Cash Detail-Rows SP (generic name)
-- File : 21_PhiLife_ExecutiveSummaryDetailRows_PMSCash.sql
-- DB   : PhiLife_LRN
--
-- Fresh rewrite mirroring PCRLabsofAmerica\21_PCRLOA_ExecutiveSummaryDetailRows_PMSCash.sql.
...
-- aggregate/read/detail SPs in 16/17/18).
--
...
PRINT '21_PhiLife_ExecutiveSummaryDetailRows_PMSCash.sql completed.';
GO
