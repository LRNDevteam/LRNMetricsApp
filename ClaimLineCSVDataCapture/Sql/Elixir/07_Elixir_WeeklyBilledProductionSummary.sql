...
-- ============================================================
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'Elix_WeeklyBilledProductionSummary')
CREATE TABLE dbo.Elix_WeeklyBilledProductionSummary
(
...
PRINT '07_Elixir_WeeklyBilledProductionSummary.sql completed.';
