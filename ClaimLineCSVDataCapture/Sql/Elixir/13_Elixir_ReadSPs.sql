-- Elixir Labs — Read stored procedures for the Production Summary Report tabs.
-- Called by LabMetricsDashboard.SqlLabProductionSummaryRepository.
--
-- Lab specifics:
--   * Weekly week boundary: Wednesday-Tuesday (anchor 1900-01-03).
...
--   * UnbilledAging snapshot uses the AgingBucket column (TotalCharges present).
-- ============================================================
...
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetElix_MonthlyBilledProductionSummary
...
BEGIN
    ...
    BEGIN
        ...
        FROM    dbo.Elix_MonthlyBilledProductionSummary
...
-- ============================================================
-- Weekly Billed Production Summary (last 4 complete Wed-Tue weeks)
-- ============================================================
...
-- Payer Breakdown
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetElix_PayerBreakdown
    @PayerNames      NVARCHAR(MAX) = NULL,
    @PanelNames      NVARCHAR(MAX) = NULL,
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
...
-- Payer x Panel
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetElix_PayerByPanel
    @PayerNames      NVARCHAR(MAX) = NULL,
    @PanelNames      NVARCHAR(MAX) = NULL,
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
...
-- ============================================================
-- Coding Breakdown (UNBILLED claims for Elixir).
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetElix_CodingBreakdown
    @PayerNames      NVARCHAR(MAX) = NULL,
    @PanelNames      NVARCHAR(MAX) = NULL,
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
...
BEGIN
    ...
    BEGIN
        ...
        FROM    dbo.Elix_CodingPanelSummary ORDER BY TotalCharges DESC;

        SELECT  PanelName, CPTCodeXUnitsXModifier, ClaimCount, TotalCharges
        FROM    dbo.Elix_CodingCPTDetail ORDER BY PanelName, TotalCharges DESC;
        RETURN;
    END
...
-- ============================================================
-- Unbilled Aging (Panelname x AgingBucket)
-- ============================================================
...
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.usp_GetElix_CPTBreakdown
    @PayerNames      NVARCHAR(MAX) = NULL,
    @PanelNames      NVARCHAR(MAX) = NULL,
    @DosFrom         DATE          = NULL,
    @DosTo           DATE          = NULL,
...
PRINT '13_Elixir_ReadSPs.sql completed.';
