-- ============================================================
-- Elixir – Executive Summary Filter Options SP
-- File : 22_Elixir_ExecutiveSummary_FilterOptions.sql
-- DB   : Elixir_LRN
-- ============================================================
SET NOCOUNT ON;
GO

CREATE OR ALTER PROCEDURE dbo.usp_GetElix_ExecutiveSummary_FilterOptions
AS
BEGIN
    SET NOCOUNT ON;
...
PRINT '22_Elixir_ExecutiveSummary_FilterOptions.sql completed.';
GO
