...
(
    ...
    OrderingPhysicianFirstName NVARCHAR(500),
    ServiceLocationCode  NVARCHAR(500),
    PrimarySubId         NVARCHAR(500),
    CptXModXUnits        NVARCHAR(MAX),
    ServiceChargeAmount  NVARCHAR(500),
...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            T_F, VisitXCptXMod, UID, PatientFirstName, PatientLastName, AgingDOS,
            ServiceToDate, AgingDOE, OrderingPhysicianFirstName, ServiceLocationCode, PrimarySubId,
            CptXModXUnits, ServiceChargeAmount, LineLevelDenialCode, DenialReason, BillingOption,
            BillStatus, BatchNo, CreatedOn, CreatedBy, UpdatedOn, UpdatedBy, PaymentPercent,
            OriginalInsertedDateTime
        )
        SELECT
            l.RecordId, 'row_replaced',
            ...
            l.T_F, l.VisitXCptXMod, l.UID, l.PatientFirstName, l.PatientLastName, l.AgingDOS,
            l.ServiceToDate, l.AgingDOE, l.OrderingPhysicianFirstName, l.ServiceLocationCode, l.PrimarySubId,
            l.CptXModXUnits, l.ServiceChargeAmount, l.LineLevelDenialCode, l.DenialReason, l.BillingOption,
            l.BillStatus, l.BatchNo, l.CreatedOn, l.CreatedBy, l.UpdatedOn, l.UpdatedBy, l.PaymentPercent,
            l.InsertedDateTime
...
PRINT 'Elixir LineLevel TVP/SP recreate script completed.';
