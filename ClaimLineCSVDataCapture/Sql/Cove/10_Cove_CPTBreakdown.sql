-- COVE Labs — CPT Breakdown (line-level)
-- Rule:
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'Cove_CPTBreakdown')
...
BEGIN
    ...
    PRINT 'usp_RefreshCove_CPTBreakdown completed — ' + CAST(@@ROWCOUNT AS NVARCHAR(20)) + ' rows.';
END
GO
...
PRINT '10_Cove_CPTBreakdown.sql completed.';
