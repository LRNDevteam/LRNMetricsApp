...
BEGIN
    ...
    (
      ...
      ProcedureField, Units, LineLevelCPT, DODWeek, DenialDate, DeniedWeek, LineLevelDenialCode, LineLevelICD,
      ModifierField, TotalWO, TotalPayment, PaymentPercent, BillStatus,
...
PRINT 'Cove ClaimLevel TVP/SP recreate script completed.';
