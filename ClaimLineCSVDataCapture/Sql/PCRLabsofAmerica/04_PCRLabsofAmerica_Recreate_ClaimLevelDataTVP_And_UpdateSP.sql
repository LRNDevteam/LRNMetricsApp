...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            PatientName, BilledUnbilled, ModifierField, PaymentPercent, Aging, AgingBucket,
            BilledWeek, PostedWeek, FullyPaidCount, FullyPaidAmount,
            AdjucticatedCount, AdjucticatedAmount,
        ...
        SELECT
            ...
            c.PatientName, c.BilledUnbilled, c.ModifierField, c.PaymentPercent, c.Aging, c.AgingBucket,
            c.BilledWeek, c.PostedWeek, c.FullyPaidCount, c.FullyPaidAmount,
            c.AdjucticatedCount, c.AdjucticatedAmount,
...
PRINT 'PCRLabsofAmerica ClaimLevel TVP/SP recreate script completed.';
