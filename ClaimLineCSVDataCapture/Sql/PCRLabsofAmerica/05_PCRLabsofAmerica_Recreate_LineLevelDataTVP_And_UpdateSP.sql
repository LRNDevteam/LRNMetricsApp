...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            PatientName, ResponsibleParty, SubscriberId, ClientAccNum, EndDOS, BillOccurance,
            EntryUser, CPTUnits, CPTMOD, CPTs, PostedWeek,
        ...
        SELECT
            ...
            l.PatientName, l.ResponsibleParty, l.SubscriberId, l.ClientAccNum, l.EndDOS, l.BillOccurance,
            l.EntryUser, l.CPTUnits, l.CPTMOD, l.CPTs, l.PostedWeek,
            l.InsertedDateTime
...
PRINT 'PCRLabsofAmerica LineLevel TVP/SP recreate script completed.';
