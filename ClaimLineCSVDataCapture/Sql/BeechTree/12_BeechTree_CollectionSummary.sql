-- =====================================================================
-- BeechTree — Collection Summary Aggregates
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_Top5ReimbursementPct')
CREATE TABLE dbo.BT_CS_Top5ReimbursementPct
(
...
CREATE TABLE dbo.BT_CS_Top5ReimbursementPay
(
    SummaryId         INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PayerRank         TINYINT         NOT NULL,
    PayerName         NVARCHAR(500)   NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_MonthlyClaimVolume')
CREATE TABLE dbo.BT_CS_MonthlyClaimVolume
(
    SummaryId         INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_WeeklyClaimVolume')
CREATE TABLE dbo.BT_CS_WeeklyClaimVolume
(
    SummaryId         INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PanelName         NVARCHAR(500)   NOT NULL,
    PayerName         NVARCHAR(500)   NOT NULL,
...
DROP TABLE IF EXISTS dbo.BT_CS_PanelAverages;
GO
CREATE TABLE dbo.BT_CS_PanelAverages
(
    SummaryId           INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PanelName           NVARCHAR(500)   NOT NULL,
    PayerName           NVARCHAR(500)   NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_AvgPayments')
CREATE TABLE dbo.BT_CS_AvgPayments
(
    SummaryId         INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PanelName         NVARCHAR(500)   NOT NULL,
    PayerName         NVARCHAR(500)   NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_InsuranceVsAging')
CREATE TABLE dbo.BT_CS_InsuranceVsAging
(
    SummaryId        INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PayerName        NVARCHAR(500)   NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_PanelVsPayment')
CREATE TABLE dbo.BT_CS_PanelVsPayment
(
    SummaryId        INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PanelName        NVARCHAR(500)   NOT NULL,
    NoOfClaims       INT             NOT NULL DEFAULT 0,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_RepVsPayment')
CREATE TABLE dbo.BT_CS_RepVsPayment
(
    SummaryId        INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_InsuranceVsPaymentPct')
CREATE TABLE dbo.BT_CS_InsuranceVsPaymentPct
(
    SummaryId        INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
    PayerName        NVARCHAR(500)   NOT NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_CptVsPaymentPct')
CREATE TABLE dbo.BT_CS_CptVsPaymentPct
(
    SummaryId            INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
DROP TABLE IF EXISTS dbo.BT_CS_StatusSummary;
GO
CREATE TABLE dbo.BT_CS_StatusSummary
(
    SummaryId        INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_CS_ProviderSummary')
CREATE TABLE dbo.BT_CS_ProviderSummary
(
    SummaryId         INT             NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_Top5ReimbursementPay
AS
BEGIN
    SET NOCOUNT ON;
    ...
    TRUNCATE TABLE dbo.BT_CS_Top5ReimbursementPay;
    INSERT INTO dbo.BT_CS_Top5ReimbursementPay
    ...
    DROP TABLE IF EXISTS #out;
    PRINT 'usp_RefreshBT_CS_Top5ReimbursementPay completed.';
END
GO


-- 3. Monthly Claim Volume  (LineLevelData, PostingDate, Top-3 payer per panel)
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_MonthlyClaimVolume
AS
BEGIN
    SET NOCOUNT ON;
    ...
    TRUNCATE TABLE dbo.BT_CS_MonthlyClaimVolume;
    INSERT INTO dbo.BT_CS_MonthlyClaimVolume
   ...
   -- WHERE k.PayerRank <= 3
    ...
    PRINT 'usp_RefreshBT_CS_MonthlyClaimVolume completed.';
END
GO


-- 4. Weekly Claim Volume (LineLevelData, PostingDate, Fri-Thu, last 4 complete weeks)
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_WeeklyClaimVolume
AS
BEGIN
    SET NOCOUNT ON;
  ...
  --  WHERE r.PayerRank <= 3;
    ...
    TRUNCATE TABLE dbo.BT_CS_WeeklyClaimVolume;
    INSERT INTO dbo.BT_CS_WeeklyClaimVolume
    ...
    DROP TABLE IF EXISTS #out;
    PRINT 'usp_RefreshBT_CS_WeeklyClaimVolume completed.';
END
GO
...
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_AvgPayments
AS
BEGIN
    SET NOCOUNT ON;
    ...
    TRUNCATE TABLE dbo.BT_CS_AvgPayments;
    INSERT INTO dbo.BT_CS_AvgPayments
    ...
    DROP TABLE IF EXISTS #out;
    PRINT 'usp_RefreshBT_CS_AvgPayments completed.';
END
GO
...
-- 8. Panel vs Payment
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_PanelVsPayment
AS
BEGIN
    SET NOCOUNT ON;

    TRUNCATE TABLE dbo.BT_CS_PanelVsPayment;

    INSERT INTO dbo.BT_CS_PanelVsPayment
    ...
    PRINT 'usp_RefreshBT_CS_PanelVsPayment completed.';
END
GO


-- 9. Rep vs Payment
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_RepVsPayment
AS
BEGIN
    SET NOCOUNT ON;

    TRUNCATE TABLE dbo.BT_CS_RepVsPayment;

    INSERT INTO dbo.BT_CS_RepVsPayment
    ...
    PRINT 'usp_RefreshBT_CS_RepVsPayment completed.';
END
GO
...
-- 11. CPT vs Payment %
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_CptVsPaymentPct
AS
BEGIN
    SET NOCOUNT ON;
    ...
    TRUNCATE TABLE dbo.BT_CS_CptVsPaymentPct;
    INSERT INTO dbo.BT_CS_CptVsPaymentPct
    ...
    DROP TABLE IF EXISTS #out;
    PRINT 'usp_RefreshBT_CS_CptVsPaymentPct completed.';
END
GO


-- 12. Status Summary
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_StatusSummary
AS
BEGIN
    SET NOCOUNT ON;

    TRUNCATE TABLE dbo.BT_CS_StatusSummary;

    INSERT INTO dbo.BT_CS_StatusSummary
    ...
    PRINT 'usp_RefreshBT_CS_StatusSummary completed.';
END
GO


-- 13. Provider Summary
CREATE OR ALTER PROCEDURE dbo.usp_RefreshBT_CS_ProviderSummary
AS
BEGIN
    SET NOCOUNT ON;
    ...
    TRUNCATE TABLE dbo.BT_CS_ProviderSummary;
    INSERT INTO dbo.BT_CS_ProviderSummary
    ...
    DROP TABLE IF EXISTS #out;
    PRINT 'usp_RefreshBT_CS_ProviderSummary completed.';
END
GO

PRINT '12_BeechTree_CollectionSummary.sql completed.';
GO
...
/*
EXEC dbo.usp_RefreshBT_CS_Top5ReimbursementPct;
EXEC dbo.usp_RefreshBT_CS_Top5ReimbursementPay;
EXEC dbo.usp_RefreshBT_CS_MonthlyClaimVolume;
EXEC dbo.usp_RefreshBT_CS_WeeklyClaimVolume;
EXEC dbo.usp_RefreshBT_CS_PanelAverages;
EXEC dbo.usp_RefreshBT_CS_AvgPayments;
EXEC dbo.usp_RefreshBT_CS_InsuranceVsAging;
EXEC dbo.usp_RefreshBT_CS_PanelVsPayment;
EXEC dbo.usp_RefreshBT_CS_RepVsPayment;
EXEC dbo.usp_RefreshBT_CS_InsuranceVsPaymentPct;
EXEC dbo.usp_RefreshBT_CS_CptVsPaymentPct;
EXEC dbo.usp_RefreshBT_CS_StatusSummary;
EXEC dbo.usp_RefreshBT_CS_ProviderSummary;

SELECT 'BT_CS_Top5ReimbursementPct'  AS [Table], COUNT(*) AS Rows, MAX(RefreshedAt) AS LastRun FROM dbo.BT_CS_Top5ReimbursementPct
UNION ALL SELECT 'BT_CS_Top5ReimbursementPay',   COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_Top5ReimbursementPay
UNION ALL SELECT 'BT_CS_MonthlyClaimVolume',     COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_MonthlyClaimVolume
UNION ALL SELECT 'BT_CS_WeeklyClaimVolume',      COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_WeeklyClaimVolume
UNION ALL SELECT 'BT_CS_PanelAverages',          COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_PanelAverages
UNION ALL SELECT 'BT_CS_AvgPayments',            COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_AvgPayments
UNION ALL SELECT 'BT_CS_InsuranceVsAging',       COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_InsuranceVsAging
UNION ALL SELECT 'BT_CS_PanelVsPayment',         COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_PanelVsPayment
UNION ALL SELECT 'BT_CS_RepVsPayment',           COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_RepVsPayment
UNION ALL SELECT 'BT_CS_InsuranceVsPaymentPct',  COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_InsuranceVsPaymentPct
UNION ALL SELECT 'BT_CS_CptVsPaymentPct',        COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_CptVsPaymentPct
UNION ALL SELECT 'BT_CS_StatusSummary',          COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_StatusSummary
UNION ALL SELECT 'BT_CS_ProviderSummary',        COUNT(*), MAX(RefreshedAt) FROM dbo.BT_CS_ProviderSummary
ORDER BY [Table];

-- Spot-check the largest tables
SELECT TOP 20 * FROM dbo.BT_CS_PanelAverages          ORDER BY PanelName, PayerName;
SELECT TOP 20 * FROM dbo.BT_CS_MonthlyClaimVolume     ORDER BY PanelName, PayerRank, BillYear, BillMonth;
SELECT TOP 20 * FROM dbo.BT_CS_WeeklyClaimVolume      ORDER BY PanelName, PayerRank, WeekKey;
SELECT *      FROM dbo.BT_CS_Top5ReimbursementPct     ORDER BY PayerRank;
SELECT *      FROM dbo.BT_CS_Top5ReimbursementPay     ORDER BY PayerRank;
*/
