...
PRINT 'Creating type dbo.LineLevelDataTVP (BeechTree)...';
...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            CPTUnits, CPTMOD, PostedWeek, PaymentPostedDate,
        ...
        SELECT
            ...
            l.PatientName, l.ResponsibleParty, l.SubscriberId, l.EndDOS, l.BillOccurance, l.EntryUser,
            l.CPTUnits, l.CPTMOD, l.PostedWeek, l.PaymentPostedDate,
            l.InsertedDateTime
...
PRINT 'BeechTree LineLevel TVP/SP recreate script completed.';
