...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'BT_WeeklyBilledProductionSummary')
CREATE TABLE dbo.BT_WeeklyBilledProductionSummary
(
...
BEGIN
    ...
    INSERT INTO dbo.BT_WeeklyBilledProductionSummary
