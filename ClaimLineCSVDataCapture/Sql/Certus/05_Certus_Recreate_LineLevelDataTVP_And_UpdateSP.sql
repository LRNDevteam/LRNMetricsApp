...
PRINT 'Creating type dbo.LineLevelDataTVP (Certus)...';
...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            T_F, UID, SubscriberId, PatientName, DiagnosisPointer,
            EnteredWeek, EnteredStatus, BilledWeek, BilledStatus,
            CPTXUnits, CPTCombined, Aging, [Description], PostedWeek,
            BilledAmounts, OriginalDenialCode, DenialCombination, PaymentPercent,
        ...
        SELECT
            ...
            l.T_F, l.UID, l.SubscriberId, l.PatientName, l.DiagnosisPointer,
            l.EnteredWeek, l.EnteredStatus, l.BilledWeek, l.BilledStatus,
            l.CPTXUnits, l.CPTCombined, l.Aging, l.[Description], l.PostedWeek,
            l.BilledAmounts, l.OriginalDenialCode, l.DenialCombination, l.PaymentPercent,
            l.InsertedDateTime
...
PRINT 'Certus LineLevel TVP/SP recreate script completed.';
