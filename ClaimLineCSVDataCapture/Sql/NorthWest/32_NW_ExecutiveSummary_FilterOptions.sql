-- ============================================================
-- NorthWest – Executive Summary Filter Options SP
-- File : 32_NW_ExecutiveSummary_FilterOptions.sql
-- DB   : NorthWest_LRN
-- ============================================================
SET NOCOUNT ON;
GO

CREATE OR ALTER PROCEDURE dbo.usp_GetNW_ExecutiveSummary_FilterOptions
AS
BEGIN
    SET NOCOUNT ON;
...
PRINT '32_NW_ExecutiveSummary_FilterOptions.sql completed.';
GO
