...
PRINT 'Creating type dbo.LineLevelDataTVP (InHealthDTR v2)...';
...
-- v2 adds: CPTXUnitsxMod, PaymentPercent, Facility, ClientAccNum.
-- v2 drops from the insert list (columns remain on table, unused): CPTUnits, PostedWeek.
...
BEGIN
	...
	BEGIN
		...
		(
			...
			CPTMOD, CPTXUnitsxMod, CPTs, PaymentPercent, Facility, ClientAccNum
		)
		SELECT
...
PRINT 'InHealthDTR LineLevel TVP/SP recreate script (v2) completed.';
