(function () {
    ...
    function seedColumnsFor(reportName) {
        ...
        const charge = r.includes("collection") ? "Total Billed"
        ...
        return [
            ...
            { columnName: action, columnType: "Text", sortOrder: 6, fieldKey: "ActionSolution" },
            { columnName: "Feedback / Response", columnType: "Text", sortOrder: 7, fieldKey: "FeedbackResponse" },
            { columnName: owner, columnType: "Text", sortOrder: 8, fieldKey: "Responsibility" },
            { columnName: "Discussion Date", columnType: "Date", sortOrder: 9, fieldKey: "DiscussionDate" },
            { columnName: "ETA", columnType: "Date", sortOrder: 10, fieldKey: "ETA" },
            { columnName: "Closed Date", columnType: "Date", sortOrder: 11, fieldKey: "ClosedDate" },
            { columnName: "Status", columnType: "Dropdown", isRequired: true, sortOrder: 12, fieldKey: "Status", dropdownValues: "Yet to Discuss|Open|In Progress|Deferred|Closed" }
        ];
    }
