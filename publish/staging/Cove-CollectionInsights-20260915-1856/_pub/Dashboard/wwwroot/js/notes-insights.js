...
(function () {
    ...
    function buildPayload(r) {
        ...
        return {
            ...
            weekRangeStart: dateOrNull(r.weekRangeStart || ctx.weekStart) || new Date().toISOString().slice(0, 10),
            weekRangeEnd: dateOrNull(r.weekRangeEnd || ctx.weekEnd || ctx.weekStart) || new Date().toISOString().slice(0, 10),
            ...
            discussionDate: dateOrNull(r.discussionDate),
            eta: dateOrNull(r.eta),
            closedDate: dateOrNull(r.closedDate),
