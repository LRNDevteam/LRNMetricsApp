...
export default function ClaimAssignmentPage({ data, reviewers, selected, setSelected, bulkReviewer, setBulkReviewer, loadClaimTasks, claimTasks, expandedClaim, assignClaims, changePage, loadMoreClaims, isLoadingClaims = false, labId, currentUser, canAssign = false, taskView = 'unassigned', setTaskView = () => {} }) {
