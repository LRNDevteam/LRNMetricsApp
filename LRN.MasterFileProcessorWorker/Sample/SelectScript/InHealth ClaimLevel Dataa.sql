...
BEGIN
    ...
    /* ============================================================
       STEP 1
       Get all unique JSON property names.

       Exclude JSON properties that already exist as physical
       columns in ClaimLevelData.

       COLLATE is required because OPENJSON [key] uses
       Latin1_General_BIN2 while sys.columns may use another collation.
       ============================================================ */
    ...
    /* ============================================================
       STEP 2
       If there are no dynamic JSON fields, return the normal
       ClaimLevelData columns.

       AdditionalFields is intentionally NOT selected.
       ============================================================ */
    ...
    /* ============================================================
       ...
       JSON fields are pivoted into columns and joined back using
       RecordId.

       AdditionalFields itself is NOT included.
       ============================================================ */
