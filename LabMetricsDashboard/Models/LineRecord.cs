...
public sealed class LineRecord
{
    ...
    public decimal ChargeAmountPerUnit { get; init; }
    public decimal AllowedAmount { get; init; }
    public decimal AllowedAmountPerUnit { get; init; }
    public decimal InsurancePayment { get; init; }
    public decimal InsurancePaymentPerUnit { get; init; }
    public decimal PatientPayment { get; init; }
    public decimal PatientPaymentPerUnit { get; init; }
    ...
    public decimal PatientBalancePerUnit { get; init; }
    ...
    public void PopulateCellsFromTyped()
    {
        ...
        PutDec("ChargeAmountPerUnit", ChargeAmountPerUnit);
        PutDec("AllowedAmount", AllowedAmount);
        PutDec("AllowedAmountPerUnit", AllowedAmountPerUnit);
        PutDec("InsurancePayment", InsurancePayment);
        PutDec("InsurancePaymentPerUnit", InsurancePaymentPerUnit);
        PutDec("PatientPayment", PatientPayment);
        PutDec("PatientPaymentPerUnit", PatientPaymentPerUnit);
        ...
        PutDec("PatientBalancePerUnit", PatientBalancePerUnit);
