/* ============================================================================
   Demo lab step 4 of 4 - register LRNDemo in LRNMaster.
...
/* No USE - Azure SQL Database cannot switch database context.
   Connect this script DIRECTLY to LRNMaster (sqlcmd: -d LRNMaster). */
GO
...
DECLARE @DemoLabId   INT           = 98;
DECLARE @DemoLabName NVARCHAR(200) = N'LRNDemo';
