...
SELECT
    ...
    ISNULL(NULLIF(LTRIM(RTRIM(CONVERT(nvarchar(4000),OrderStatus))), ''), '') AS OrderStatus,
	ISNULL(NULLIF(LTRIM(RTRIM(CONVERT(nvarchar(4000),PaymentMethod))), ''), '') AS PaymentMethod,
