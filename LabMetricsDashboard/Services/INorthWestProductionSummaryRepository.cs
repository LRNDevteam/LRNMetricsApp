...
public interface INorthWestProductionSummaryRepository
{
    ...
    /// <summary>Calls usp_GetNW_PanelBreakdown — panel × month unique ClaimID + ChargeAmount.</summary>
    ...
    /// <summary>Calls usp_GetNW_HighestPayerBreakdown � Source (Daq/WebPM) groups with PayerName_Raw children.</summary>
